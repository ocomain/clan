...
<div style="max-width:580px;margin:0 auto;background:#F8F4EC">
  ...
  <div style="padding:40px">
    ...
    <p style="font-family:'Georgia',serif;font-size:17px;color:#3C2A1A;line-height:1.8;margin:0 0 20px">The founding-place gift is a one-time courtesy from the Chief's own hand, given in this founding year only. It is not re-offered. Should you wish to join Clan Ó Comáin in future, the door remains open through the standard membership of the clan (pricing on website). Membership is a contribution to the heritage and cultural revival of Ó Comáin and Gaelic Ireland &mdash; but the founding place set down in your name today will not be set down again.</p>
