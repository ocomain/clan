...
<div style="max-width:580px;margin:0 auto;background:#F8F4EC">
  ...
  <div style="padding:36px 40px">
    ...
    <p style="font-family:'Georgia',serif;font-size:17px;font-style:italic;color:#3C2A1A;line-height:1.85;margin:0 0 18px">
      I write at the wish of Fergus Commane, the Chief of Clan Ó Comáin, who has set down your name among those he calls home in this first hour of the clan's revival. The Chief has thought of you, by name, as one of those he wishes to see standing with him from its first day. The membership for the year ahead is his gift to you, freely given, and asks nothing of you in return but that you take your place.
    </p>

    <p style="font-family:'Georgia',serif;font-size:17px;font-style:italic;color:#3C2A1A;line-height:1.85;margin:0 0 18px">
      Clan Ó Comáin is an ancient Gaelic royal house, formally revived in 2025 and recognised by Clans of Ireland under the patronage of the President of Ireland. After eight centuries of silence it has been gathered again — and, as in the old Brehon tradition where clans were never built on blood alone, its doors are open to all who feel a pull toward Ireland, her story, and the company of those who keep faith with her.
    </p>
...
<div style="max-width:580px;margin:0 auto;background:#F8F4EC">
  ...
  <div style="padding:40px">
    <p style="font-family:'Georgia',sans-serif;font-size:10px;font-weight:600;letter-spacing:0.22em;text-transform:uppercase;color:#B8975A;margin:0 0 12px">A final notice</p>
    ...
    <p style="font-family:'Georgia',serif;font-size:17px;color:#3C2A1A;line-height:1.8;margin:0 0 20px">The founding-place gift is a one-time courtesy from the Chief's own hand, given in this founding year only. It is not re-offered. Should you wish to join Clan Ó Comáin in future, the door remains open through the standard membership of the clan (pricing on website). Membership is a contribution toward the costs of reviving the heritage and culture of Ó Comáin and Gaelic Ireland &mdash; but the founding place set down in your name today will not be set down again.</p>
    ...
    <!-- Secondary CTA: prominent link to the website for those who'd
         like to look around the clan before deciding (or who don't
         intend to claim but might want to know more). Outlined gold
         button is visually subordinate to the burgundy primary
         action while still being unambiguously prominent and
    ...
    <p style="font-family:'Georgia',serif;font-size:15px;color:#3C2A1A;line-height:1.7;margin-top:28px;margin-bottom:0">— The Herald, on behalf of <em>Fergus Commane</em></p>
  </div>
