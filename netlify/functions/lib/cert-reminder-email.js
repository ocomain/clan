...
<div style="max-width:580px;margin:0 auto;background:#F8F4EC">
  <div style="background:#0C1A0C;padding:36px 40px 28px;text-align:center;border-bottom:2px solid #B8975A">
    <img src="https://www.ocomain.org/images/brand/coat_of_arms.png" width="76" alt="Ó Comáin" style="display:block;margin:0 auto 6px;height:auto"><p style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:0.18em;color:#B8975A;margin:0 auto 18px;text-align:center;max-width:76px">Ó COMÁIN</p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0 0;width:100%">
      <tr>
        <td style="vertical-align:middle;padding-right:18px;width:84px">
          <img src="https://www.ocomain.org/images/people/linda_cryan_bubble.png" width="68" height="68" alt="Linda Cryan" style="display:block;width:68px;height:68px;border-radius:50%">
        </td>
