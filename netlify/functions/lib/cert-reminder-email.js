...
<div style="max-width:580px;margin:0 auto;background:#F8F4EC">
  ...
  <div style="padding:36px 40px">
    ...
    <div style="text-align:center;margin:0 0 28px">
      <a href="${signInUrl}" style="display:inline-block;background:#B8975A;color:#0C1A0C;font-family:sans-serif;font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;text-decoration:none;padding:14px 30px;border-radius:1px">Refine and publish now &rarr;</a>
