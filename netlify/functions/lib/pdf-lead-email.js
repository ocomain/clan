...
${p(`<strong>Guardian of the Clan — €150 individual, €220 family.</strong> All the foregoing, with the certificate posted as a physical document on heritage stock. Your name on the public Founding Members Register at Newhall. A personal letter from the Chief on headed Newhall stationery. A place at the table at the private annual Chief's Black Tie Gala at Newhall House, with the Chief and Privy Council. First right of refusal on open Privy Council positions.`)}
...
${p(`If you would consider one of the higher tiers — <strong>Guardian</strong> for the public Register and the Chief's Black Tie Gala at Newhall House, <strong>Life Member</strong> for the standing in perpetuity — I am happy to answer any question you might have. Please do write back.`)}
${ctaButtonHtml('Take a place in the Register', URLS.joinChat)}
${p(`With kind regards,`)}
${lindaSignatureHtml()}
`;
