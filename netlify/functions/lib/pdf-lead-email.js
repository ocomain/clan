...
${p(`Clan Ó Comáin is <strong>authenticated by Clans of Ireland</strong>, the official body of the Republic established in 1989 under the patronage of the President. The committee verified the antiquity of the Gaelic name and the line, and recognised the clan formally as an Irish Gaelic clan and ancient royal house. There are very few such authentications, and they are not lightly given.`)}
...
${p(`I mention all of this so that you might know what you are looking at. There is no obligation; but if you do choose to join, you will find it is a real Irish Gaelic clan, with real history, and a welcome that is genuinely open to anyone who loves Ireland.`)}
${p(`With kind regards,`)}
${lindaSignatureHtml()}
`;
  return wrapInChrome({
...
${p(`I should mention something the Chief considers important. The certificate names the holder, and — for those who join as a family — names the spouse and the children, with an inheritance clause by which the children carry their place in the clan into adulthood in their own right. <strong>One certificate. One Irish Gaelic clan. One family, three generations deep.</strong> It is the most enduring Irish heirloom we know how to make.`)}
...
${p(`<strong>Guardian of the Clan — €150 individual, €220 family.</strong> All the foregoing, with the certificate posted as a physical document on heritage stock. Your name on the public Founding Members Register at Newhall. A personal letter from the Chief on headed Newhall stationery. A place at the table at the private annual Guardians dinner at Newhall House, with the Chief and Privy Council. First right of refusal on open Privy Council positions.`)}
...
${p(`If you would consider one of the higher tiers — <strong>Guardian</strong> for the public Register and the Guardians dinner at Newhall, <strong>Life Member</strong> for the standing in perpetuity — I am happy to answer any question you might have. Please do write back.`)}
${ctaButtonHtml('Take a place in the Register', URLS.joinChat)}
${p(`With kind regards,`)}
${lindaSignatureHtml()}
`;
