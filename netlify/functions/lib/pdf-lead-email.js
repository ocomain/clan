...
<div style="max-width:580px;margin:0 auto;background:#F8F4EC">
  ...
  <div style="background:#0C1A0C;padding:22px 40px;text-align:center;border-top:1px solid rgba(184,151,90,.2)">
    ...
    <p style="font-family:sans-serif;font-size:10px;color:#A88B57;margin:0 0 12px;letter-spacing:0.08em">Moohane LLC · 30 N Gould St Ste 36809, Sheridan, WY 82801, USA · <a href="https://www.ocomain.org/terms.html" style="color:#A88B57;text-decoration:underline">Terms</a> · <a href="https://www.ocomain.org/privacy.html" style="color:#A88B57;text-decoration:underline">Privacy</a></p>
