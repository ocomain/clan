...
exports.handler = async (event) => {
  ...
  const html = `<div style="font-family:Georgia,serif;max-width:620px;color:#3C2A1A">
    ...
    <p style="margin-top:24px;font-size:12px;color:#8F7A5E;font-style:italic">Submitted via the Member's Area obituary form. Reply directly to the member's email above${photoAttachment ? '' : ' to request the portrait photograph'}.</p>
  </div>`;
